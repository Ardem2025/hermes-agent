...
_SKILL_REVIEW_PROMPT = (
    ...
    "CRITICAL RULE FOR SKILLS: When updating or patching any existing skill (via skill_manage), you MUST call skill_view(name) (or skill_view(name, file_path=...) for support files) first in the current turn. The tool will reject any patch/edit if you have not loaded the target file in the same turn.\n\n"
