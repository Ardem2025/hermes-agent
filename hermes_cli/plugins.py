...
VALID_HOOKS: Set[str] = {
    ...
    # its native topic binding.  It is the safe point for tenant plugins that
    # need the authoritative Hermes session id; callbacks are observers except
    # for their own tenant-local projections.
